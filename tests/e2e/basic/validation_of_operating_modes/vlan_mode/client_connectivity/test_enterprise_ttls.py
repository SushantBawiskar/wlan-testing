...
pytestmark = [pytest.mark.ow_client_connectivity_lf, pytest.mark.vlan, pytest.mark.enterprise, pytest.mark.ttls,
              pytest.mark.ucentral, pytest.mark.sanity,pytest.mark.enterprise_client_connectivity,pytest.mark.wg_client_connectivity,pytest.mark.vlan]  # pytest.mark.usefixtures("setup_test_run")
