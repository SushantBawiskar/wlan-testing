...
pytestmark = [pytest.mark.wg_client_connectivity, pytest.mark.vlan, pytest.mark.general, pytest.mark.ucentral,
              pytest.mark.sanity,pytest.mark.basic_client_connectivity,pytest.mark.vlan]  # pytest.mark.usefixtures("setup_test_run")]
